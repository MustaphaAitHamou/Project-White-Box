/* ------------------------------------------------------------------
   src/create-trip/index.jsx — version « sobre & classe »
------------------------------------------------------------------- */
...
export default function CreateTrip() {
  ...
  async function generateTrip() {
    ...
    try {
      const r   = await chatSession.sendMessage(prompt)
      const res = JSON.parse(await r.response.text())
        ...
        <Dialog open={openDialog} onOpenChange={setOpenDialog}>
          ...
          <DialogContent>
            ...
            <Button
              onClick={() => {
                if (!consentChecked)
                  return setConsentError("Merci d’accepter les conditions")
                login()
              }}
